...
namespace ErrorDumper\StepGenerators;
...
class Html implements StepGeneratorInterface
{
    ...
    /**
     * @param callable $varDump
     * @param EditorInterface $editor
     */
    public function __construct($varDump, EditorInterface $editor)
    {
        Exceptions::throwIfIsNotCallable($varDump);
    ...
    {
        $params = isset($step['args']) ? $step['args'] : [];
        if (!$params)
        {
            return [];
        }
